...
import img from"../assets/chair1.png"
...
const Feature = () => {
  ...
  return (
    ...
    <Slider {...settings}>  
        ...
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-[20%] px-2 group ">
          ...
          <div className="drop-shadow-xl">
            <div className="lg:w-full w-[90%] h-[361px] relative overflow-hidden lg:mx-0 mx-auto">
              <div className="pt-[46px] -z-10 pb-[12px] px-[40px] bg-[#F6F7FB]">
                <img className='h-[200px] mx-auto' src={img} alt="" />
              </div>

              <div className="">
                <button className='absolute opacity-0 bottom-[140px] duration-500 z-10 group-hover:opacity-100 right-[50%] translate-x-[50%] text-[12px] text-white font-josefin font-medium py-[8px] px-[13px] bg-[#08D15F] rounded-[3px]'>View Details</button>
              </div>

              <div className="text-center z-50 bg-white group-hover:bg-[#2F1AC4] duration-500 ease-in-out pt-[15px] pb-[17px]">
                <h4 className='text-[18px] text-[#FB2E86] font-josefin font-bold group-hover:text-white duration-500'>10.99</h4>
